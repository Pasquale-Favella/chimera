...
const STATIC_MODELS: LlmModelInfo[] = [
    { id: "gemini-2.5-flash-lite", name: "Gemini 2.5 Flash Lite", provider: LlmProvider.GOOGLE },
    { id: "gemini-2.5-flash", name: "Gemini 2.5 Flash", provider: LlmProvider.GOOGLE },
    { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", provider: LlmProvider.GOOGLE },
];
