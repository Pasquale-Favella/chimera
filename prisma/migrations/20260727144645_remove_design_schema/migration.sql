/*
  ...
  - You are about to drop the column `schema` on the `design` table. All the data in the column will be lost.
...
INSERT INTO "new_design" ("createdAt", "createdById", "data", "description", "history", "html", "id", "name", "position", "projectId", "size", "tokens", "updatedAt", "version", "viewMode") SELECT "createdAt", "createdById", "data", "description", "history", "html", "id", "name", "position", "projectId", "size", "tokens", "updatedAt", "version", "viewMode" FROM "design";
DROP TABLE "design";
